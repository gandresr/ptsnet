...
from ptsnet.simulation.init import get_initial_conditions

inpfile = '/home/griano/Documents/Github/ptsnet/example_files/LoopedNet_leak_us.inp'
rptfile = '/home/griano/Documents/Github/ptsnet/example_files/LoopedNet_leak_us.rpt'
outfile = '/home/griano/Documents/Github/ptsnet/example_files/LoopedNet_leak_us.out'
...
# Extracting results with ptsnet
...
H = ic['node'].head['5']
F = ic['node'].demand['5']
ptsnet_result = K*P**0.5

# Results Comparison
print("EPA", epa_result)
print("PHAMMER", ptsnet_result)
