...
inpfile = '/home/griano/Documents/Github/phammer/example_files/simple_pump.inp'
...
plt.plot(tt, sim.worker.pipe_end_results.flowrate['p1'])
plt.plot(tm.simulation_timestamps,p1.end_node_flowrate)
